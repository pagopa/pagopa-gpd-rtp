...
class IngestionServiceImplTest {
    ...
    @MockBean
    private RTPMessageProducer rtpMessageProducer;
    @MockBean
    ...
    @MockBean
    private AnonymizerClient anonymizerClient;
    @MockBean
    ...
    @Captor
    private ArgumentCaptor<RTPMessage> rtpCaptor;

    @Test
    void ingestPaymentOptions_OK_DELETE() {
    ...
    @Test
    void ingestPaymentOptions_OK_CREATE() {
    ...
    @Test
    void ingestPaymentOptions_OK_UPDATE() {
    ...
    @ParameterizedTest()
    @EnumSource(
            value = DebeziumOperationCode.class,
            names = {"t", "r", "m"}
    )
    void ingestPaymentOptions_KO_DEBEZIUM_OPERATION_DISCARDED(DebeziumOperationCode opCode) {
        DataCaptureMessage<PaymentOptionEvent> po = getPaymentOption(opCode);
    ...
    @Test
    void ingestPaymentOptions_KO_MESSAGE_NULL_DISCARDED() {
    ...
    @Test
    void ingestPaymentOptions_KO_INVALID_TAX_CODE_DISCARDED() {
        DataCaptureMessage<PaymentOptionEvent> po = getPaymentOption(DebeziumOperationCode.c);
        when(rtpMessageProducer.sendRTPMessage(any(RTPMessage.class))).thenReturn(true);
    ...
    @Test
    void ingestPaymentOptions_KO_REPLICA_SYNC_FAILED_NO_PO() {
        DataCaptureMessage<PaymentOptionEvent> po = getPaymentOption(DebeziumOperationCode.c);
        when(rtpMessageProducer.sendRTPMessage(any(RTPMessage.class))).thenReturn(true);
    ...
    @Test
    void ingestPaymentOptions_KO_REPLICA_SYNC_FAILED_ON_DATE() {
        DataCaptureMessage<PaymentOptionEvent> po = getPaymentOption(DebeziumOperationCode.c);
        when(rtpMessageProducer.sendRTPMessage(any(RTPMessage.class))).thenReturn(true);
    ...
    @Test
    void ingestPaymentOptions_KO_INVALID_TRANSFER_CATEGORIES() {
        DataCaptureMessage<PaymentOptionEvent> po = getPaymentOption(DebeziumOperationCode.c);
        when(rtpMessageProducer.sendRTPMessage(any(RTPMessage.class))).thenReturn(true);
    ...
    @Test
    void ingestPaymentOptions_KO_INVALID_TRANSFER_AMOUNTS() {
        DataCaptureMessage<PaymentOptionEvent> po = getPaymentOption(DebeziumOperationCode.c);
        when(rtpMessageProducer.sendRTPMessage(any(RTPMessage.class))).thenReturn(true);
    ...
    @Test
    void ingestPaymentOptions_KO_NO_PRIMARY_TRANSFER() {
        DataCaptureMessage<PaymentOptionEvent> po = getPaymentOption(DebeziumOperationCode.c);
        when(rtpMessageProducer.sendRTPMessage(any(RTPMessage.class))).thenReturn(true);
    ...
    @Test
    void ingestPaymentOptions_KO_ERROR_SENDING_RTP_MESSAGE() {
        DataCaptureMessage<PaymentOptionEvent> po = getPaymentOption(DebeziumOperationCode.c);
        when(rtpMessageProducer.sendRTPMessage(any(RTPMessage.class))).thenReturn(true);
    ...
    @Test
    void ingestPaymentOptions_KO_ERROR_GENERIC() {
        DataCaptureMessage<PaymentOptionEvent> po = getPaymentOption(DebeziumOperationCode.c);
        when(rtpMessageProducer.sendRTPMessage(any(RTPMessage.class))).thenReturn(true);
    ...
    @Test
    void ingestPaymentOptions_KO_DB_REPLICA_SYNC_0_retry() {
        DataCaptureMessage<PaymentOptionEvent> po = getPaymentOption(DebeziumOperationCode.c);
        when(rtpMessageProducer.sendRTPMessage(any(RTPMessage.class))).thenReturn(true);
    ...
    @Test
    void ingestPaymentOptions_KO_DB_REPLICA_SYNC_4_retry() {
        DataCaptureMessage<PaymentOptionEvent> po = getPaymentOption(DebeziumOperationCode.c);
        when(rtpMessageProducer.sendRTPMessage(any(RTPMessage.class))).thenReturn(true);
    ...
    @Test
    void ingestPaymentOptionsBatch_KO_partialAckAndIndexedNack() {
    ...
    @Test
    void ingestPaymentOptionsBatch_OK_ignoreAndAckWholeBatch() {
