...
class IngestionServiceImplTest {
    ...
    private static final AnonymizerModel ANONIMIZED_RESPONSE = AnonymizerModel.builder().text("anonimizedRemittance").build();
    ...
    void ingestPaymentOption_OK_DELETE() throws JsonProcessingException {
        ...
        Message<String> genericMessage = new GenericMessage<>(objectMapper.writeValueAsString(po), headers);
    ...
    @Test
    void ingestPaymentOption_KO_INVALID_PAYMENT_POSITION_STATUS_DISCARDED() throws JsonProcessingException {
        DataCaptureMessage<PaymentOptionEvent> po = getPaymentOption(DebeziumOperationCode.c);
        Map<String, Object> headers = Map.of(KafkaHeaders.ACKNOWLEDGMENT, acknowledgment);
        Message<String> genericMessage = new GenericMessage<>(objectMapper.writeValueAsString(po), headers);

        doThrow(new AppException(AppError.PAYMENT_POSITION_STATUS_NOT_VALID_FOR_RTP)).when(filterService).isValidPaymentOptionForRTPOrElseThrow(any());
    ...
    void ingestPaymentOption_KO_INVALID_TAX_CODE_DISCARDED() throws JsonProcessingException {
        ...
        doThrow(new AppException(AppError.TAX_CODE_NOT_VALID_FOR_RTP)).when(filterService).isValidPaymentOptionForRTPOrElseThrow(any());
    ...
    void ingestPaymentOption_KO_INVALID_TRANSFER_CATEGORIES() throws JsonProcessingException {
        ...
        doThrow(new AppException(AppError.TRANSFERS_CATEGORIES_NOT_VALID_FOR_RTP)).when(filterService).hasValidTransferCategoriesOrElseThrow(any(), any());
    ...
    void ingestPaymentOption_KO_INVALID_TRANSFER_AMOUNTS() throws JsonProcessingException {
        ...
        doThrow(new AppException(AppError.TRANSFERS_TOTAL_AMOUNT_NOT_MATCHING)).when(filterService).hasValidTransferCategoriesOrElseThrow(any(), any());
    ...
    private DataCaptureMessage<PaymentOptionEvent> getPaymentOption(DebeziumOperationCode debeziumOperationCode) {
