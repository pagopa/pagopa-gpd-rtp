...
public interface HelpdeskService {
   ...
   * @param numberOfMessages Retrieve only the defined amount of messages
   */
  List<String> getBlobList(String year, String month, String day, String hour, int numberOfMessages);
