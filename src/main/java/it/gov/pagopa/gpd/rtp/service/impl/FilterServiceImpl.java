...
public class FilterServiceImpl implements FilterService {
     ...
     * proseguire. Condizioni che rendono lo stato non valido: - l'evento è una creazione (Debezium code
     * c) e lo stato è DRAFT o PUBLISHED. - lo stato è REPORTED.
     */
    private boolean isInvalidPaymentPositionStatus(
        ...
        return paymentPosition == null
                ...
                || isPaymentPositionCreateWithStatusDraftOrPublished(debeziumOperationCode, paymentPosition.getStatus())
