...
public class FilterServiceImpl implements FilterService {
  ...
  public void isValidPaymentOptionForRTPOrElseThrow(
    ...
    if (!ServiceType.GPD.equals(valuesAfter.getServiceType())) {
   ...
   *     proseguire. Condizioni che rendono lo stato non valido: - valuesAfter è null. - lo
   *     paymentPositionStatus dentro valuesAfter è null. - l'evento è una creazione (Debezium code
