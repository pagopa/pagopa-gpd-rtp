...
public class IngestionServiceImpl implements IngestionService {
    ...
    private RTPMessage createRTPMessageOrElseThrow(
        ...
        if (paymentOption.getOp().equals(DebeziumOperationCode.c)
            ...
            log.debug("PaymentOption ingestion called at {} with payment option id {}", LocalDateTime.now(), valuesAfter.getId());
    ...
    private RTPMessage mapRTPMessage(
            DataCaptureMessage<PaymentOptionEvent> paymentOption, String remittanceInformation, @NotNull PaymentPositionStatus status) {
        PaymentOptionEvent valuesAfter = paymentOption.getAfter();
