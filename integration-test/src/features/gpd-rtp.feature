...
Feature: All about RTP events
  ...
  Background:
    ...
    And a create transfer with id prefix '123123', category '9/0201102IM/', remittance information of primary ec '/RFB/091814449948492/547.24/TXT/DEBITORE/VNTMHL76M09H501D' and associated to the previous payment option on GPD database
  ...
  Scenario: New payment option in GPD database is published into RTP event hub
    ...
    And the 'create' operation has the first transfer's remittance information
